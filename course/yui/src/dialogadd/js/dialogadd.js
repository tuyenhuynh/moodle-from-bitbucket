    ...
    Y.extend(DIALOG, Y.Base, {
            ...
            submit_click: function (e) {
                ...
                if(eval(validatorName)()){
                    ...
                    Y.io(M.cfg.wwwroot + "/course/rest.php?class=addmodule&courseId="+courseId, cfg);    
                }
            },
            /**
            ...
            update_course : function (id, o) {
                //TODO: avoid rerendering the whole page
                // Update course view
                document.open();
             ...
             */
            show_form: function (id, res, params) {
            ...
            on_click: function (e) {
                ...
                url = M.cfg.wwwroot + "/course/rest.php" + query_string + '&class=addmodule';
