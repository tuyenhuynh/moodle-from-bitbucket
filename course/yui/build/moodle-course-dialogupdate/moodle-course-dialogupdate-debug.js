YUI.add('moodle-course-dialogupdate', function (Y, NAME) {
    ...
    var CSS = {
        ...
        MODULENAME      : '#panelContentUpdate form#mform1 input[name=modulename]', 
    ...
    Y.extend(DIALOG, Y.Base, {
            ...
            post_success : function (id, o, self) {
                if(o.responseText.indexOf(CSS.FORM) === -1) {
                    ...
                    if(query.id.indexOf('#') > 0) {
                       query.id = query.id.split('#')[0];      
                    }
            ...
            show_form: function (x, o) {
                ...
                Y.one(CSS.FORMCONTAINER).setStyle("height","500px");
            ...
            on_click: function (e,self) {
                ...
                Y.io(M.cfg.wwwroot + '/course/rest.php'+
                    url.substr(url.indexOf('?')) + '&class=updatemod&courseId='+params.id, cfg);
            },
            /**
